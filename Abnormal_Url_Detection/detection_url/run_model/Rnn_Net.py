...
# @FileName: Rnn_Net.py
from detection_url.tools.time_log import run_timer
from detection_url.utils.utils import get_vocab_size, get_num_classes, load_word2vec_embedding
...
def train(net, sess):
    ...
    while True:
        ...
        sess.run(net.iterator.initializer,
                 #   feed_dict 参数向启动计算的 run() 或 eval () 调用提供 feed 数据。
